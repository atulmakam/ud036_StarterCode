...
def main():
    ...
    spectre = media.Movie("Spectre",
                          "James Bond receives an obscure message when he uncovers the conspiracy.",
    ...
    mad_max = media.Movie("Mad Max: Fury Road", 
                       " A woman rebels against a tyrannical ruler in search for her home-land with the help of a drifter named Max.",
    ...
    interstellar = media.Movie("Interstellar",
                        "Earth is slowly becoming uninhabitable. Ex-NASA pilot Cooper, along with a team of researchers, is sent on a planet exploration mission to report which planet can sustain life.", 
